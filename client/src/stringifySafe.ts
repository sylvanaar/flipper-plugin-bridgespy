  ...
  function replacer(this: unknown, key: string, value: unknown): unknown {
    ...
    if (Array.isArray(value)) {
      ...
      if (stack.length >= maxDepth) {
        ...
        retval = {};
        if (typeof retval !== "object") return;
        for (let k of keys.slice(0, maxObjectKeysLimit)) {
          (retval as Record<string, unknown>)[k] = (value as Record<string, unknown>)[k];
        }
        const truncatedKey = "...(truncated keys)...";
        (retval as Record<string, unknown>)[truncatedKey] = keys.length - maxObjectKeysLimit;
      }
    }
  ...
  return function stringifySafe(arg: unknown): string {
    if (arg === undefined) {
      ...
      try {
        ...
        if (typeof arg === "object" && arg && typeof arg.toString === "function") {
          try {
...
const stringifySafe: (arg0: unknown) => string = createStringifySafeWithLimits({
  maxDepth: 10,
  maxStringLimit: 100,
  maxArrayLimit: 50,
